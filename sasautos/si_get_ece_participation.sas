...
The script creates a flag of children who have been at ECE. There is also the option to specifically 
identify those who have attended Kohanga
...
HISTORY: 
17 Jul 2017 EW distinct added so that this script just does  a flag of ECE attendance
19 Jun 2017 EW v1
*********************************************************************************************************/
		...
		create table &si_ece_table_out. as 
			...
			from [IDI_Sandpit].[&si_ece_proj_schema.].[&si_ece_table_in.] a
				...
				%do;
					...
					and b.event_type_2 = 20631 and b.start_date <= &si_ece_asat_date.
				%end;
			);
