...
si_sial_libname		   = libname used to reference the IDI_USercode database, e.g. sialview
...
NOTES: 
A complete example is shown in ../examples/ folder.

HISTORY: 
24 May 2018 VB Added a new parameter for SAS dsn name for SQL server
07 Nov 2017 WJ Added cyf parameter
25 Aug 2017 VB Added more comments.
12 May 2017 EW v1
July 2019 Updates for SAS Grid and Windows 10 upgrade in IDI
*********************************************************************************************************/
...
si_id_col,
si_asat_date,
si_num_periods_before,
si_num_periods_after,
si_period_duration,
si_amount_type,
si_sial_amount_col,
si_price_index_type,
...
si_rollup_duration,
si_rollup_count,
si_rollup_count_sdate,
si_rollup_dayssince,
si_idi_clean_version,
;
run;
...
%global 
	...
	si_rollup_output_type si_idi_clean_version
	si_rollup_cost        si_rollup_duration   si_rollup_count
	si_rollup_count_sdate si_rollup_dayssince	si_idi_dsnname;
